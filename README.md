...
**Final Project: Paradise Nursery Shopping Application**
 _A part of Module 4 of Developing Front-End Apps with React_

repository name: e-plantShopping

GitHub repository URL:  https://github.com/ramalber/e-plantShopping

Live URL or URL of the deployed application: https://ramalber.github.io/e-plantShopping/
